"""Tests for agents package — BaseAgent, ReOSAgent."""
...
from reos.agents.base_agent import AgentContext, AgentResponse, BaseAgent
...
class TestBaseAgent:
    """Test BaseAgent ABC and common methods via ReOSAgent."""
