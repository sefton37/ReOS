    ...
    def _get_persona(self) -> dict[str, Any]:
        ...
        return {
            "system_prompt": (
                ...
                "- linux_run_command: Execute ANY shell command (docker, apt, systemctl, etc.)\n"
                ...
                "- When user confirms (yes, proceed, do it, I confirm), EXECUTE the command!\n"
                "- For Docker: use linux_run_command with 'docker stop X', 'docker rm X', etc.\n"
                "- For services: use linux_run_command with 'sudo systemctl stop X'\n"
                "- For packages: use linux_run_command with 'sudo apt remove X'\n"
                "- Don't just describe what to do - actually DO IT when confirmed!\n\n"
                "GUIDELINES:\n"
                "- ALWAYS use tools to get real system data - never make up information\n"
                "- For system questions, call linux_system_info\n"
